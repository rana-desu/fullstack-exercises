...
const App = () => {
  ...
  const addPerson = (event) => {
    ...
    if (alreadyExists) {
      ...
      if (confirm) {
        const updatedPerson = { ...alreadyExists, number: newPersonObject.number }
  ...
  const onPhoneNumberInputChange = event => setNewNumber(event.target.value)
  ...
  return (
    <div>
      ...
      <PersonForm 
        ...
        onChange={{name: onNameInputChange, number: onPhoneNumberInputChange}}
      />
